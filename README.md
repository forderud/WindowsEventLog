...
`/rd:true` means events are displayed from newest to oldest, and `/f:text` displays them as text instead of XML. 86400000 is the number of milliseconds in 24 hours (24 hours * 60 minutes * 60 seconds * 1000 milliseconds).
...
### Log subtypes
Naming convention for per-application [log subtypes](https://techcommunity.microsoft.com/blog/itopstalkblog/understanding-the-windows-server-event-log/4417350):
